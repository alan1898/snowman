...
void DETC_test::setup_test(signed long int num) {
    clock_t start, end;
...
void DETC_test::keygen_test(signed long int num) {
    clock_t start, end;
    double execution_time;
    double sum_time_20 = 0;
    ...
    // set up
    vector<Key*> *psk = detc.setUp(attributes);

    for (signed long int i = 0; i < 20; ++i) {
        start = clock();
        detc.keyGen(psk->at(1), psk->at(0), attributes);
        end = clock();
        execution_time = (double)(end-start)/CLOCKS_PER_SEC * 1000;
        sum_time_20 += execution_time;
    }
...
void DETC_test::encrypt_test(signed long int num) {
    clock_t start, end;
    double execution_time;
    double sum_time_20 = 0;
    ...
    for (signed long int i = 0; i < 20; ++i) {
        start = clock();
        detc.encrypt(psk->at(1), as, message);
        end = clock();
        execution_time = (double)(end-start)/CLOCKS_PER_SEC * 1000;
        sum_time_20 += execution_time;
    }
...
void DETC_test::trapdoor_test(signed long int num) {
    clock_t start, end;
    double execution_time;
    double sum_time_20 = 0;
    ...
    for (signed long int i = 0; i < 20; ++i) {
        start = clock();
        detc.trapdoor(psk->at(1), psk->at(0), attributes);
        end = clock();
        execution_time = (double)(end-start)/CLOCKS_PER_SEC * 1000;
        sum_time_20 += execution_time;
    }
...
void DETC_test::test_test(signed long int num) {
    clock_t start, end;
    double execution_time;
    double sum_time_20 = 0;
    ...
    // key gen
    SecretKey *user1_sk = detc.keyGen(psk->at(1), psk->at(0), attributes);
    SecretKey *user2_sk = detc.keyGen(psk->at(1), psk->at(0), attributes);

    // encrypt
    Ciphertext_CET* ciphertext1 = detc.encrypt((*psk)[1], as1, message1);
    Ciphertext_CET* ciphertext2 = detc.encrypt(psk->at(1), as2, message2);

    // trapdoor
    SecretKey *tds1 = detc.trapdoor(psk->at(1), psk->at(0), attributes);
    SecretKey *tds2 = detc.trapdoor(psk->at(1), psk->at(0), attributes);

    for (signed long int i = 0; i < 20; ++i) {
        start = clock();
        detc.test(psk->at(1), ciphertext1, tds1, ciphertext2, tds2);
        end = clock();
        execution_time = (double)(end-start)/CLOCKS_PER_SEC * 1000;
        sum_time_20 += execution_time;
    }
...
void DETC_test::decrypt_test(signed long int num) {
    clock_t start, end;
    double execution_time;
    double sum_time_20 = 0;
    ...
    // key gen
    SecretKey *user_sk = detc.keyGen(psk->at(1), psk->at(0), attributes);

    // encrypt
    Ciphertext_CET* ciphertext = detc.encrypt((*psk)[1], as, message);
