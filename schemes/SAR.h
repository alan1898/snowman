...
public:
    ...
    void tkeyUp(abe_key *public_key, sar_kgc *kgc);
    void tkeyUp(abe_key *public_key, string attribute, sar_kgc *kgc);

    abe_key* tranKG(abe_key *public_key, string user_id, sar_kgc *kgc);
